...
const initialProjectLayers: ProjectLayer[] = [
  {
    id: "rb_ecology",
    name: "Raised Bog Ecology Map (based on NLCM)",
    group: "Raised Bogs",
    enabled: true,
    bounds: [
      [53.3, -6.4],
  ...
  {
    id: "rb_slope_ipsm",
    name: "Raised Bog Slope Map (based on IPSM)",
    group: "Raised Bogs",
    enabled: true,
    bounds: [
      [53.31, -6.42],
  ...
  {
    id: "rb_slope_nlcm",
    name: "Raised Bog Slope Map (based on NLCM)",
    group: "Raised Bogs",
    enabled: true,
    bounds: [
      [53.32, -6.43],
  ...
  {
    id: "rb_soil_ipsm",
    name: "Raised Bog Soil Type (based on IPSM)",
    group: "Raised Bogs",
    enabled: true,
    bounds: [
      [53.33, -6.44],
  ...
  {
    id: "bb_morph_nlcm",
    name: "Blanket Bog Morphology (based on NLCM)",
    group: "Blanket Bogs",
    enabled: true,
    bounds: [
      [53.2, -6.2],
  ...
  {
    id: "bb_slope_nlcm",
    name: "Blanket Bog Slope Map (based on NLCM)",
    group: "Blanket Bogs",
    enabled: true,
    bounds: [
      [53.21, -6.22],
  ...
  {
    id: "bb_lowland_morph_ipsm",
    name: "Lowland Atlantic Blanket Bog Morphology (based on IPSM)",
    group: "Blanket Bogs",
    enabled: true,
    bounds: [
      [53.22, -6.24],
  ...
  {
    id: "bb_lowland_soil_ipsm",
    name: "Lowland Atlantic Blanket Bog Soil Type (based on IPSM)",
    group: "Blanket Bogs",
    enabled: true,
    bounds: [
      [53.23, -6.26],
  ...
  {
    id: "bb_mountain_morph_ipsm",
    name: "Mountain Blanket Bog Morphology (based on IPSM)",
    group: "Blanket Bogs",
    enabled: true,
    bounds: [
      [53.24, -6.28],
  ...
  {
    id: "bb_mountain_soil_ipsm",
    name: "Mountain Blanket Bog Soil Type (based on IPSM)",
    group: "Blanket Bogs",
    enabled: true,
    bounds: [
      [53.25, -6.3],
  ...
  return (
    <div className="geo-app">
      ...
      <div className="sidebar">
        <div className="base-layers">
          <div
            className={`base-preview ${
              selectedBaseLayer === "default" ? "active" : ""
            }`}
            onClick={() => setSelectedBaseLayer("default")}
          >
            Default
          </div>
          <div
            className={`base-preview ${
              selectedBaseLayer === "satellite" ? "active" : ""
            }`}
        ...
        >
          <SortableContext
            items={projectLayers.map((l) => l.id)}
